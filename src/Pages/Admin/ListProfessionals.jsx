...
function ListProfessionals() {
  ...
  const FetchUserInfo = async (e) => {
    try {
      ...
      const professional = data.filter((user) => user.role === "professional");
          ...
          <table className="mt-4 w-full min-w-max table-auto text-left">
            ...
            <tbody>
              {professional.map((professional, index) => {
                const isLast = index === professional.length - 1;
                    ...
                    <td className={classes}>
                      <div className="w-max">
                        <Chip
                          variant="ghost"
                          size="sm"
                          value={professional.is_active ? "active" : "blocked"}
                          color={professional.is_active ? "green" : "blue-gray"}
                        />
                      </div>
                    </td>
                    <td className={classes}>
                          ...
                          {professional.is_active ? (
                            <NotificationModal
                              ...
                              onOkClick={async () => {
                                ...
                                await BlockUser(professional.id, data);
                                await FetchUserInfo()
